...
export const megaMenuCoursesByCategory: Record<string, MegaMenuCourse[]> = {
  ...
  skill: [
    { id: "19", title: "Mastering Docker for Software Developers", image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&h=300&fit=crop", categoryId: "skill" },
    { id: "20", title: "Advanced JavaScript", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&h=300&fit=crop", categoryId: "skill" },
    { id: "21", title: "Python Fundamentals", image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&h=300&fit=crop", categoryId: "skill" },
    { id: "22", title: "React Mastery", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=500&h=300&fit=crop", categoryId: "skill" },
    { id: "23", title: "Cloud Deployment", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&h=300&fit=crop", categoryId: "skill" },
    { id: "24", title: "Database Design", image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&h=300&fit=crop", categoryId: "skill" },
  ],
  popular: [
