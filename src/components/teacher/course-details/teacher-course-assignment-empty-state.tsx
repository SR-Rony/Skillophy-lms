...
import type { TeacherCourseAssignmentsEmptyState } from "@/types/teacher-course-details.types";

interface TeacherCourseAssignmentEmptyStateProps {
  emptyState: TeacherCourseAssignmentsEmptyState;
}

export function TeacherCourseAssignmentEmptyState({
  emptyState,
}: TeacherCourseAssignmentEmptyStateProps) {
  return (
