...
import { teacherFaqData } from "@/components/public/teachers/data/teacher-faq.data";

export function TeacherFaqSection() {
  const { label, title, description, faqs } = teacherFaqData;
      ...
      >
        <div className="grid items-start gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16 xl:gap-20">
          ...
          >
            ...
            <Heading as="h2" variant="blog-section">
              {title}
            </Heading>
