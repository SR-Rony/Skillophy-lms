...
export function FaqAccordion({ faqs, mode = "multiple", className }: FaqAccordionProps) {
  ...
  return (
    <div className={cn("overflow-hidden rounded-[16px] border border-[#ece6e3] bg-white", className)}>
      {faqs.map((item, index) => {
