...
import type {
  AdminJobOpeningExportId,
  AdminJobOpeningExportOption,
  AdminJobOpeningSortId,
  AdminJobOpeningSortOption,
} from "@/types/admin-job-opening-management.types";
import { cn } from "@/utils";

interface AdminJobOpeningManagementToolbarProps {
  searchQuery: string;
  sortOptions: AdminJobOpeningSortOption[];
  exportOptions: AdminJobOpeningExportOption[];
  selectedSortId: AdminJobOpeningSortId;
  exportLabel: string;
  addNewLabel: string;
  onSearchChange: (value: string) => void;
  onSortChange: (sortId: AdminJobOpeningSortId) => void;
  onExport: (exportId: AdminJobOpeningExportId) => void;
  onAddNew: () => void;
}
...
function ExportOptionIcon({
  ...
  exportId: AdminJobOpeningExportId;
  className?: string;
}) {
  if (exportId === "csv") {
...
export function AdminJobOpeningManagementToolbar({
  searchQuery,
  sortOptions,
  exportOptions,
  selectedSortId,
  ...
  onExport,
  onAddNew,
}: AdminJobOpeningManagementToolbarProps) {
