...
import type { AdminEmployeeProfileInfoData } from "@/types/admin-employee-profile.types";

interface AdminEmployeeProfileInfoTabProps {
  data: AdminEmployeeProfileInfoData;
}

export function AdminEmployeeProfileInfoTab({ data }: AdminEmployeeProfileInfoTabProps) {
