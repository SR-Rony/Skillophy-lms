...
interface AdminWorkshopCreationPageHeaderProps {
  isEditing: boolean;
...
export function AdminWorkshopCreationPageHeader({
  isEditing,
  isMetaInfoStep,
  showBack,
  showNext,
  ...
  onPublish,
  onSaveDraft,
}: AdminWorkshopCreationPageHeaderProps) {
  return (
    <div className="space-y-5">
      <Link
        href={ROUTES.admin.workshop}
