...
import type {
  ...
  AdminWorkshopCategoryOption,
  AdminWorkshopExportId,
  AdminWorkshopExportOption,
  AdminWorkshopSortId,
  AdminWorkshopSortOption,
} from "@/types/admin-workshop-management.types";
import { cn } from "@/utils";

interface AdminWorkshopManagementToolbarProps {
  searchQuery: string;
  categoryOptions: AdminWorkshopCategoryOption[];
  sortOptions: AdminWorkshopSortOption[];
  exportOptions: AdminWorkshopExportOption[];
  selectedCategoryId: AdminWorkshopCategoryId;
  selectedSortId: AdminWorkshopSortId;
  exportLabel: string;
  addNewLabel: string;
  onSearchChange: (value: string) => void;
  onCategoryChange: (categoryId: AdminWorkshopCategoryId) => void;
  onSortChange: (sortId: AdminWorkshopSortId) => void;
  onExport: (exportId: AdminWorkshopExportId) => void;
  onAddNew: () => void;
}
...
function ExportOptionIcon({
  ...
  exportId: AdminWorkshopExportId;
  className?: string;
}) {
  if (exportId === "csv") {
...
export function AdminWorkshopManagementToolbar({
  searchQuery,
  categoryOptions,
  sortOptions,
  exportOptions,
  ...
  onExport,
  onAddNew,
}: AdminWorkshopManagementToolbarProps) {
