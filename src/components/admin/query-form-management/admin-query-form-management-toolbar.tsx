...
import type {
  AdminQueryFormExportId,
  AdminQueryFormExportOption,
  AdminQueryFormSortId,
  AdminQueryFormSortOption,
} from "@/types/admin-query-form-management.types";
import { cn } from "@/utils";

interface AdminQueryFormManagementToolbarProps {
  searchQuery: string;
  sortOptions: AdminQueryFormSortOption[];
  exportOptions: AdminQueryFormExportOption[];
  selectedSortId: AdminQueryFormSortId;
  exportLabel: string;
  onSearchChange: (value: string) => void;
  onSortChange: (sortId: AdminQueryFormSortId) => void;
  onExport: (exportId: AdminQueryFormExportId) => void;
}
...
function ExportOptionIcon({
  ...
  exportId: AdminQueryFormExportId;
  className?: string;
}) {
  if (exportId === "csv") {
...
export function AdminQueryFormManagementToolbar({
  searchQuery,
  sortOptions,
  exportOptions,
  selectedSortId,
  ...
  onSortChange,
  onExport,
}: AdminQueryFormManagementToolbarProps) {
