...
import type {
  AdminLiveCoursesData,
  AdminRecordedCourseCategoryId,
  AdminRecordedCourseSortId,
} from "@/types/admin-course-management.types";

interface AdminLiveCoursesTabProps {
  data: AdminLiveCoursesData;
}

export function AdminLiveCoursesTab({ data }: AdminLiveCoursesTabProps) {
  ...
  return (
    <>
      <AdminRecordedCoursesToolbar
        ...
        onExport={() => undefined}
        onAddNew={() => router.push(ROUTES.admin.courseCreateLive)}
      />
