...
import type {
  AdminRoleExportId,
  AdminRoleExportOption,
  AdminRoleSortId,
  AdminRoleSortOption,
} from "@/types/admin-role-management.types";
import { cn } from "@/utils";

interface AdminRoleManagementToolbarProps {
  searchQuery: string;
  sortOptions: AdminRoleSortOption[];
  exportOptions: AdminRoleExportOption[];
  selectedSortId: AdminRoleSortId;
  exportLabel: string;
  addNewLabel: string;
  onSearchChange: (value: string) => void;
  onSortChange: (sortId: AdminRoleSortId) => void;
  onExport: (exportId: AdminRoleExportId) => void;
  onAddNew: () => void;
}
...
export function AdminRoleManagementToolbar({
  searchQuery,
  sortOptions,
  exportOptions,
  selectedSortId,
  ...
  onExport,
  onAddNew,
}: AdminRoleManagementToolbarProps) {
