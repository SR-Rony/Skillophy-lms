...
import type { AdminTeacherRecordedCourse } from "@/types/admin-teacher-profile.types";

interface AdminTeacherProfileRecordedCoursesTableProps {
  courses: AdminTeacherRecordedCourse[];
}

export function AdminTeacherProfileRecordedCoursesTable({
  courses,
}: AdminTeacherProfileRecordedCoursesTableProps) {
  return (
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <td className="whitespace-nowrap px-4 py-3.5 text-[13px] font-medium text-[#757575] sm:px-6">
                {formatAdminTeacherPublishDate(course.publishDate)}
              </td>
