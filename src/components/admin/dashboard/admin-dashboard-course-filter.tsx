...
import type { AdminDashboardCourseFilter } from "@/types/admin-dashboard.types";

interface AdminDashboardCourseFilterProps {
  courseFilters: AdminDashboardCourseFilter[];
  selectedCourseId: string;
}

export function AdminDashboardCourseFilter({
  courseFilters,
  selectedCourseId,
}: AdminDashboardCourseFilterProps) {
