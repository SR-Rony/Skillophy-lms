...
import type { AdminEmployeeTab } from "@/types/admin-employee-management.types";
import { cn } from "@/utils";

const tabs: { id: AdminEmployeeTab; label: string }[] = [
  { id: "all", label: "All" },
  { id: "employee", label: "Employee" },
  { id: "teacher", label: "Teacher" },
];

interface AdminEmployeeManagementTabsProps {
  activeTab: AdminEmployeeTab;
  onTabChange: (tab: AdminEmployeeTab) => void;
}

export function AdminEmployeeManagementTabs({
  activeTab,
  onTabChange,
}: AdminEmployeeManagementTabsProps) {
  return (
